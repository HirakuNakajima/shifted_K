...
that $A \Xi = \xi A$. It becomes surjective.
...
and corresponds to the point $x^{\dim V_i - N}\cO \subset \cO$ in the
affine Grassmannian for $\C^\times$. Thus $\prod_{i=1}^w [A_i,\xi_i]$
is identified with the cocharacter $(\dim V_1-N,\cdots,\dim V_w-N)$ of
$G$.
...
$\cL_1\cong \oW_\cO$. The third space $G_\cK \times_{G_\cO} \Gr_{G}$
...
$\cL_3 = \cL_2$, $\eta$ as the composition of $\kappa$ and the inverse
of the inclusion $\cL_3\subset \oW_\cK$. For the map $m$, we first
define the embedding $\cL_3\subset \oW_\cK$ as the composite of
$\eta^{-1}$ and $\cL_1\otimes_\cO\cK\xrightarrow{\cong} \oW_\cK$. Then
we consider $\cL_3$ as a lattice in $\oW_\cK$.
